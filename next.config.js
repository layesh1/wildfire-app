...
const nextConfig = {
  // Leaflet + react-leaflet throw "Map container is already initialized" under React 18/19
  // Strict Mode (dev double-mount). Evacuation map uses the same LeafletMap component.
