...
export default function SignalGapsPanel({ embedded = false }: { embedded?: boolean }) {
    ...
    <div className={embedded ? 'space-y-6' : 'p-8 max-w-5xl mx-auto'}>
      ...
      {embedded && (
        <p className="text-ash-500 text-sm">
          State-level signal lead times and equity context — complements the WiDS summary in this dashboard.
        </p>
      )}
