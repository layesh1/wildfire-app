...
const GlowingEffect = memo(
  ({
    ...
    const fireGradient = `radial-gradient(circle, #ff6b00 10%, #ff6b0000 20%),
      radial-gradient(circle at 40% 40%, #ff3d00 5%, #ff3d0000 15%),
      radial-gradient(circle at 60% 60%, #ffab00 10%, #ffab0000 20%),
      radial-gradient(circle at 40% 60%, #ff1744 10%, #ff174400 20%),
      repeating-conic-gradient(
        from 236.84deg at 50% 50%,
        #ff6b00 0%,
        #ff3d00 calc(25% / var(--repeating-conic-gradient-times)),
        #ffab00 calc(50% / var(--repeating-conic-gradient-times)),
        #ff1744 calc(75% / var(--repeating-conic-gradient-times)),
        #ff6b00 calc(100% / var(--repeating-conic-gradient-times))
      )`;
