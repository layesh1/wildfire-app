  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="mt-3 flex items-center gap-2">
          <span className="text-xs px-2 py-0.5 rounded-full bg-ash-800 border border-ash-700 text-ash-400 font-mono">
            Source: WiDS 2025 · WatchDuty dataset · 62,696 incidents
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {[
          { icon: Flame, value: '62,696', label: 'Total fire incidents', sub: '2021–2025 full dataset', color: 'text-ember-500' },
          { icon: AlertTriangle, value: '73.5%', label: 'Silent fires', sub: '46,053 of 62,696', color: 'text-signal-warn' },
